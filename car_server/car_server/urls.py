...
urlpatterns = [
    ...
    url(r'^go_forward/$', views.Controller.go_forward, name='go_forward'),
    ...
    url(r'^go_reverse_left/$', views.Controller.go_reverse_left, name='go_reverse_left'),
]
